    ...
    <section className="py-24 bg-black-surface relative" id="location">
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          ...
          >
            {lang === 'en' ? 'Our Locations' : 'فروعنا وموقعنا'}
          </motion.h2>
          <motion.div 
          ...
          >
            <div className="text-center lg:text-right">
              ...
              <div className="flex items-start justify-center lg:justify-start gap-4 mb-6 text-right">
                ...
                <div>
                  <h4 className="font-bold text-lg text-text-light mb-1">{lang === 'en' ? 'Address' : 'العنوان'}</h4>
                  <p className="text-text-muted leading-relaxed">{address}</p>
                </div>
              </div>
              ...
              <div className="flex items-start justify-center lg:justify-start gap-4 mb-8 text-right">
                ...
                <div>
                  <h4 className="font-bold text-lg text-text-light mb-1">{lang === 'en' ? 'Working Hours' : 'مواعيد العمل'}</h4>
                  <p className="text-text-muted leading-relaxed">{hours}</p>
                </div>
              </div>
              ...
              <button 
                ...
                className="inline-flex items-center justify-center gap-2 w-full bg-black-primary hover:bg-black text-text-light font-bold py-4 px-6 rounded-xl transition-colors duration-300"
              >
                <Navigation size={20} />
          ...
          >
            {mapIframe.includes('<iframe') ? (
              ...
              <div className="w-full h-full flex flex-col items-center justify-center bg-black-primary text-center p-6 border-4 border-dashed border-wood-dark/50">
                ...
                <a href={mapIframe} target="_blank" rel="noopener noreferrer" className="bg-black-primary hover:bg-black text-text-light font-bold py-3 px-8 rounded-xl transition-colors">
